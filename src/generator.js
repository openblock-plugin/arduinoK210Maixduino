export default Blockly => {
    ...
    Blockly.Arduino.arduino_pin_setPwmOutput = function (block) {
        ...
        Blockly.Arduino.setups_.setPwmOutput = 'analogWriteFrequency(490);';
    ...
    Blockly.Arduino.arduino_serial_multiSerialBegin = function (block) {
        let no = block.getFieldValue('NO') || '0';
        ...
        const code = `Serial${no}.begin(${baud}, ${rxPin}, ${txPin});\n`;
        return code;
    };
    ...
    Blockly.Arduino.arduino_pin_k210SetPwmOutput = Blockly.Arduino.arduino_pin_setPwmOutput;
    Blockly.Arduino.arduino_serial_k210MultiSerialBegin = Blockly.Arduino.arduino_serial_multiSerialBegin;
